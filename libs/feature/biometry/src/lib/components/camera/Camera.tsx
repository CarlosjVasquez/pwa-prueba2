...
export default class Camera extends React.Component<WebcamProps, WebcamState> {
  static defaultProps = {
    audio: false,
  ...
  override componentDidUpdate(nextProps: WebcamProps) {
    const { props } = this;
  ...
  private stopAndCleanup() {
    ...
    if (state.hasUserMedia) {
      Camera.stopMediaStream(this.stream as any);
